      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-800">Welcome to our Blog Segment </h2>
          </div>
          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-start md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
            ...
            <div className="md:w-7/12 lg:w-1/2" data-aos="fade-up">
              <div className="mb-8 text-center md:text-left">
                ...
                <p className="text-xl text-slate-500">Our goal is simple: to inspire, educate, and connect a community of like-minded creatives who share a passion for capturing the beauty that surrounds us. Through articles, tutorials, interviews, shared experiences and featured work, we'll explore the myriad facets of photography, offering insights for photographers of all levels.</p>
              </div>
              {/* Tabs buttons */}
              ...
              <Link href="/blog">
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Chabod Stitches</div>
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Bluehouse Technologies</div>
                    <div className="text-slate-500">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur velit.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Vic-Stitches</div>
                    <div className="text-slate-500">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur velit.</div>
                  </div>
                </button>
                </Link>
