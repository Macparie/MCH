          ...
          <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-start md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
            ...
            <div className="md:w-7/12 lg:w-1/2" data-aos="fade-up">
              <div className="mb-8 text-center md:text-left">
                ...
                <p className="text-xl text-slate-500">Partner with Macparie Creative House and embark on a journey of mutual growth, creativity, and success. Let's create exceptional experiences and lasting memories together.Contact us today to explore the exciting possibilities that await when we join forces.</p>
              </div>
              {/* Tabs buttons */}
