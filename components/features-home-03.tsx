...
export default function FeaturesHome03() {
  return (
    <section className="relative">
      ...
      {/* Dark background */}
      <div className="absolute inset-0 bg-slate-700 pointer-events-none opacity-20 -z-10 [clip-path:polygon(0_360px,_5760px_0,_5760px_calc(100%_-_360px),_0_100%)] h-96 md:h-auto md:mb-64" aria-hidden="true"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-500">Welcome to our Partnership Segment</h2>
            <p className="text-xl text-slate-600">Partner with Macparie Creative House and embark on a journey of mutual growth, creativity, and success. Let's create exceptional experiences and lasting memories together.Contact us today to explore the exciting possibilities that await when we join forces.
</p>
          </div>
