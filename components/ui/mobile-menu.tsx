      ...
      >
        ...
        >
          <ul className="px-5 py-2">
            ...
            <li>
              <Link href="/signin" className="flex font-medium w-full text-2xl font-FontleroyBrownNF text-slate-800 hover:text-blue-600 py-2" onClick={() => setMobileNavOpen(false)}>Sign in</Link>
            </li>
            <li>
              <Link href="/request-demo" className="flex text-2xl font-FontleroyBrownNF text-blue-600 py-2 group" onClick={() => setMobileNavOpen(false)}>
